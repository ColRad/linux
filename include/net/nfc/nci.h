...
#define NCI_MAX_ROUTING_ENTRY_LEN				3
...
/* NCI LA_SEL_INFO id and config params */
#define NCI_LA_SEL_INFO						0x32
#define NCI_LA_SEL_INFO_NFC_DEP					0x40
#define NCI_LA_SEL_INFO_ISO_DEP					0x20
...
/* NCI Deactivation Reason */
#define NCI_DEACTIVATE_REASON_DH_REQUEST			0x00
#define NCI_DEACTIVATE_REASON_ENDPOINT_REQUEST			0x01
#define NCI_DEACTIVATE_REASON_RF_LINKLOSS			0x02
#define NCI_DEACTIVATE_REASON_NFC_B_BAD_AFI			0x03

/* NCI Listen Mode Routing params */
#define NCI_LM_ROUNTING_LAST					0x00
#define NCI_LM_ROUNTING_MORE					0x01

/* NCI Listen Mode Routing Type */
#define NCI_LM_TYPE_TECH_BASED					0x00
#define NCI_LM_TYPE_PROT_BASED					0x01
#define NCI_LM_TYPE_AID_BASED					0x02
...
struct lm_routing_entry {
	__u8	type;
	__u8	len;
	__u8	val[NCI_MAX_ROUTING_ENTRY_LEN];
} __packed;

struct nci_rf_set_listen_mode_routing_cmd {
	__u8				more;
	__u8				nb_entries;
	struct lm_routing_entry		routing_entry;
} __packed;
